...
const CreateTicket = () => {
  ...
  const handleRemoveAttachment = (index) => {
    setFormData((prev) => {
      ...
      const updatedPreviews = prev.attachmentPreviews.filter(
        (_, i) => i !== index
      );
      return {
        ...prev,
        attachments: updatedFiles,
        attachmentPreviews: updatedPreviews,
      };
    });
  };
  ...
  return (
    <div className="create-ticket-container mt-5">
      <Nav />
      <div className="ticket-form-wrapper">
        ...
        <form className="ticket-form" onSubmit={handleSubmit}>
          ...
          <input
            className="ticket-input text-secondary"
            type="text"
            name="requestor"
          ...
          <div className="form-group">
            ...
            <select
              className="form-control ticket-select"
              name="category"
          ...
          <button className="ticket-submit-button" type="submit">
            Submit
          </button>
        </form>
      </div>
